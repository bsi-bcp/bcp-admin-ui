    ...
    >
      ...
      >
        <el-form-item v-if="cur_user.userType==='admin'" label="客户" prop="tenantId">
          <el-select v-model="subFormData.tenantId" placeholder="请选择" @change="getSourceTypeOptions">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button v-prevent-repeat-click size="mini" type="primary" @click="subForm('subFormData')">确 定
        </el-button>
...
export default {
  ...
  computed: {
    ...
    getConfigTask() {
      const configId = this.subFormData.configId
